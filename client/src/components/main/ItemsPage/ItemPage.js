...
function ItemPage({productData }) {
    ...
    return(
        <div> 
            ...
            <h4>{productData.Category}--{productData.SubCategory}</h4>
            ...
            <Box sx={{ width: '100%' }}>
                <Stack spacing={{ xs: 1, sm: 2 }} useFlexGap flexWrap="wrap">
                    ...
                    <Item><AccessTimeIcon/> {productData.Lead_Times} Business Days</Item>
                    <Item><MonitorWeightIcon />{productData.Product_Weight}</Item>
