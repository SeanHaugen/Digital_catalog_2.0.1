            ...
            <Table sx={{ minWidth: 650 }} size="small" aria-label="a dense table">
                ...
                <TableBody>
                    ...
                    <TableRow>
                        ...
                        <TableCell align="center">{handlePrice(productData.Prc1)}</TableCell>
                        <TableCell align="center">{handlePrice(productData.Prc2)}</TableCell>
                        <TableCell align="center">{handlePrice(productData.Prc3)}</TableCell>
                        <TableCell align="center">{handlePrice(productData.Prc4)}</TableCell>
                        <TableCell align="center">{handlePrice(productData.Prc5)}</TableCell>
                    </TableRow>
                    <TableRow>
                        ...
                        <TableCell align="center">{handlePrice(productData.Prc4)}</TableCell>
                        <TableCell align="center">{handlePrice(productData.Prc5)}</TableCell>
                        <TableCell align="center">{handlePrice(productData.Prc6)}</TableCell>
                    </TableRow>
                    <TableRow>
                        ...
                        <TableCell align="center">{handlePrice(productData.Prc5)}</TableCell>
                        <TableCell align="center">{handlePrice(productData.Prc6)}</TableCell>
                        <TableCell align="center">{handlePrice(productData.Prc7)}</TableCell>
                    </TableRow>
                    <TableRow>
                        ...
                        <TableCell align="center">{handlePrice(productData.Prc6)}</TableCell>
                        <TableCell align="center">{handlePrice(productData.Prc7)}</TableCell>
                        <TableCell align="center">{handlePrice(productData.Prc8)}</TableCell>
